...
namespace BorderForce\Drt\EntityBundle\Command;
...
use BorderForce\Drt\EntityBundle\Generator\SerializableEntityGenerator;

class GenerateDoctrineSerializableEntitiesCommand extends GenerateEntitiesDoctrineCommand
{
    /**
     * {@inheritDoc}
     */
    ...
    {
        $this
            ->setName('doctrine:generate:serializableentities')
            ->setAliases(array('generate:doctrine:serializableentities'))
...
You have to limit generation of serializable entities:
...
* To a single entity:
  ...
  <info>php app/console doctrine:generate:serializableentities MyCustomBundle:User</info>
  <info>php app/console doctrine:generate:serializableentities MyCustomBundle/Entity/User</info>

* To a namespace

  <info>php app/console doctrine:generate:serializableentities MyCustomBundle/Entity</info>
...
you must provide the <comment>--path</comment> option:
  ...
  <info>php app/console doctrine:generate:serializableentities Blog/Entity --path=src/</info>
...
pass the <comment>--no-backup</comment> option:
  ...
  <info>php app/console doctrine:generate:serializableentities Blog/Entity --no-backup</info>
...
EOT
    ...
    {
        $entityGenerator = new SerializableEntityGenerator();
...
//    {
//        return new DoctrineSerializableEntityGenerator($this->getContainer()->get('filesystem'), $this->getContainer()->get('doctrine'));
//    }
}
